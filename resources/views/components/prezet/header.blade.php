<header
    ...
    <div class="relative flex grow basis-0 items-center">
        <button aria-label="Menu" class="mr-4 rounded-lg p-1.5 hover:bg-gray-100 active:bg-gray-200 lg:hidden"
            ...
            <svg class="h-6 w-6 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
    ...
    <div class="relative flex basis-0 items-center justify-end gap-3 sm:gap-8 md:grow lg:gap-6">
        <x-prezet.search />
        <a class="group" aria-label="GitHub" href="https://github.com/irfanjoelax/mip-stack" target="_blank">
            <svg aria-hidden="true" viewBox="0 0 16 16" class="h-6 w-6 fill-gray-400 group-hover:fill-gray-500">
                <path
